  ...
  <div className="form-container__footer">
      ...
      >
        <g>
          <path
            ...
            fill="#ffa100"
            d="M29.653 201.648.957 289.816c-2.599 8.006.208 16.843 7.07 21.834l247.972 180.183-79.366-155.859-146.98-134.326zM482.347 201.648l28.696 88.168c2.599 8.006-.208 16.843-7.07 21.834L256.001 491.832l87.212-184.854 139.134-105.33z"
          ></path>
          <path
            data-original="#ff6d18"
            fill="#ff6d18"
            d="m256 491.832-.001-178.6-94.302-111.585-65.97-32.822-66.074 32.822L256 491.832zM256 491.832l.001-189.402 94.302-100.783 71.367-32.822 60.677 32.822L256 491.832z"
          ></path>
          <path
            data-original="#fc3819"
            fill="#fc3819"
            d="m256 491.832 94.302-290.185H161.698L256 491.832z"
          ></path>
          <path
            data-original="#fc3819"
            fill="#fc3819"
            d="M29.654 201.65h132.148L104.929 26.874c-2.911-8.942-15.596-8.942-18.611 0L29.654 201.65zM482.346 201.65H350.198l56.769-174.776c2.911-8.942 15.596-8.942 18.611 0l56.768 174.776z"
          ></path>
        </g>
      </svg>
    </button>
    <button className="social">
      ...
      >
        <g>
          <path
            data-original="#2684ff"
            fill="#2684ff"
            d="M16.436 25.814c-10.23 0-17.903 9.378-16.198 18.756l69.056 422.86c1.705 11.085 11.083 18.756 22.166 18.756h334.196c7.674 0 14.494-5.967 16.198-13.641l69.907-427.123c1.707-10.231-5.967-18.756-16.196-18.756l-479.129-.852zm293.275 305.21H203.143l-28.134-150.899H336.14l-26.429 150.899z"
          ></path>
          <linearGradient
            ...
            id="a"
          >
            <stop style={{ stopColor: '#0052CC' }} offset=".176"></stop>
            <stop style={{ stopColor: '#2684FF' }} offset="1"></stop>
          </linearGradient>
          <path
            fill="url(#a)"
            d="M488.743 180.125H335.286L309.71 331.024H203.14L77.818 480.219s5.968 5.116 14.493 5.116h334.196c7.674 0 14.494-5.969 16.198-13.643l46.038-291.567z"
          ></path>
        </g>
      </svg>
    </button>
